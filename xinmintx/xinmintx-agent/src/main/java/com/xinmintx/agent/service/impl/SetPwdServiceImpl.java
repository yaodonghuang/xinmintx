...
import com.xinmintx.agent.service.SetPwdService;
import com.xinmintx.agent.util.HttpUtil;
...
public class SetPwdServiceImpl implements SetPwdService {
    ...
    @Override
    public Map setPwd(Map<String, String> paramMap) {
        // 初始化Map
        initMap(paramMap);
        // 调用扣费方法
        return pay(paramMap);
    ...
    private PostMethod initPostValue(Map<String, String> paramMap) {
        ...
        //支付密码RSA加密
        pwd = StringUtil.encryptWarrantr(pwd,"D:/huishang/xinmintx/xinmintx-agent/src/main/resources/00000000035514.cer");
