...
import com.xinmintx.agent.service.RelieveBindService;
...
public class RelieveBindServiceImpl implements RelieveBindService {
    ...
    private PostMethod initPostValue(Map<String, String> paramMap) {
        ...
        //支付密码RSA加密
        pwd = com.xinmintx.agent.util.StringUtil.encryptWarrantr(pwd,"D:/huishang/xinmintx/xinmintx-agent/src/main/resources/00000000035514.cer");
