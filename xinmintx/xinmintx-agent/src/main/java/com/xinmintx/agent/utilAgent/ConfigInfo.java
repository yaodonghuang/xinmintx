...
public class ConfigInfo {
	...
	public  static cfca.x509.certificate.X509Cert X509Cert;
	...
	public static String publicCer;
	...
	static {
		...
		try {
			...
			publicCer = properties.getProperty("publicCer");
	...
	public static String getPublicCer() {
		return publicCer;
	}

	public static void setPublicCer(String publicCer) {
		ConfigInfo.publicCer = publicCer;
	}
}