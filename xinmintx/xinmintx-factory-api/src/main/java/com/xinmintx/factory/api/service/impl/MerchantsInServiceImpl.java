...
import com.xinmintx.factory.api.service.MerchantsInService;
...
/**
 * @ClassName: com.xinmintx.factory.service.impl.MerchantsInServiceImpl
 * @Author:Pikachu
...
public class MerchantsInServiceImpl implements MerchantsInService {
    ...
    @Override
    public ResultCode merchantsIn(Map<String, String> paramMap) {
        // 初始化Map
        initMap(paramMap);
        // 生成post方法
        return pay(paramMap);
    ...
    private PostMethod initPostValue(Map<String, String> paramMap) {
        ...
        String companyBrief = paramMap.get("companyBrief");// 商户名称 中文转16进制
        ...
        String storeName = paramMap.get("storeName");//商城名称
        ...
        post.addParameter("companyBrief", HexConver.Str2Hex(companyBrief));
    ...
    private String getSignature(Map<String, String> paramMap) {
        ...
        map.put("companyBrief",HexConver.Str2Hex(paramMap.get("companyBrief")));
