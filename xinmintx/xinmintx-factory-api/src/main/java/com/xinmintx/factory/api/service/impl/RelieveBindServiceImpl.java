...
import com.xinmintx.factory.api.service.RelieveBindService;
...
public class RelieveBindServiceImpl implements RelieveBindService {
    ...
    @Override
    public void relieveBind(Map<String, String> paramMap) {
        // 初始化Map
        initMap(paramMap);
        // 生成post方法
        pay(paramMap);
    ...
    private PostMethod initPostValue(Map<String, String> paramMap) {
        ...
        //支付密码RSA加密
        pwd = com.xinmintx.factory.api.parity.StringUtil.encryptWarrantr(pwd,"C:/Users/Administrator/Desktop/hs/xinmintx/xinmintx-factory/src/main/resources/00000000035514.cer");
