...
import com.xinmintx.factory.api.service.BalanceEnquiryService;
...
/**
 * @ClassName: com.xinmintx.factory.service.impl.BalanceEnquiryServiceImpl
 * @Author:Pikachu
...
public class BalanceEnquiryServiceImpl implements BalanceEnquiryService {
    @Override
    public ResultCode balanceEnquiry(Map<String, String> paramMap) {
        // 初始化Map
        initMap(paramMap);
        // 生成post方法
        return pay(paramMap);
    ...
    private void initMap(Map<String, String> paramMap) {
        ...
        paramMap.put("postUrl", "https://www.56zhifu.com/user/BalanceQuery.do");
    }
    // 调用支付接口
    ...
    private PostMethod initPostValue(Map<String, String> paramMap) {
        ...
        String acType = paramMap.get("acType");//账户类型
        // 获取签名
        ...
        post.addParameter("acType",acType);
    ...
    private String getSignature(Map<String, String> paramMap) {
        ...
        map.put("acType",paramMap.get("acType"));
