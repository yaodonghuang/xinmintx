...
import com.xinmintx.merchant.mapper.ExclusiveBoardMapper;
import com.xinmintx.merchant.model.Gift;
import com.xinmintx.merchant.model.StoreInformation;
import com.xinmintx.merchant.service.ExclusiveBoardService;
...
public class ExclusiveBoardServiceImpl implements ExclusiveBoardService {
    ...
    @Override
    public List queryAllShop(@RequestParam("regionCode") String regionCode) {
        List<StoreInformation>list = exclusiveBoardMapper.queryAllShop(regionCode);
