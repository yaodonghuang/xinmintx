...
public class GlobalExceptionHandler {
    ...
    public ResultCode ExceptionHandler(HttpServletResponse response, Exception ex) {
        ...
        return new ResultCode(Integer.valueOf(ErrorCodeConStants.SYSTEM_EX_OTHER_CODE.getCode()), ex.getMessage());
    }
    ...
    public ResultCode BaseExceptionHandler(HttpServletResponse response, BaseRunException ex) {
        logger.error(ex.getMessage(), ex);
